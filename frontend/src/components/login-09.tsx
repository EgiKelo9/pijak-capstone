        ...
        <div className="space-y-5 mt-2">
            <div className="space-y-1.5">
              ...
              <Select defaultValue="designer">
                <SelectTrigger
                  id="role"
                  className="w-full text-sm border-neutral-800/20 focus:ring-[#2BBAEE]/50 [&>span]:flex [&>span]:items-center [&>span]:gap-2 [&>span_svg]:shrink-0"
                >
            ...
            <div className="flex items-center space-x-2">
              <Checkbox id="terms" className="data-[state=checked]:bg-[#2BBAEE] data-[state=checked]:border-[#2BBAEE]" />
              <label htmlFor="terms" className="text-sm text-neutral-600 font-normal">
                I agree to the{" "}
                <Link href="#" className="text-[#2BBAEE] hover:underline">
                  Terms
                </Link>{" "}
                and{" "}
                <Link href="#" className="text-[#2BBAEE] hover:underline">
