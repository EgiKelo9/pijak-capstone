    ...
    <div className="flex h-full flex-1 w-full flex-col items-center justify-center rounded-2xl border border-neutral-800/20 bg-white p-6 md:p-8">
      <div className="flex w-full max-w-2xl flex-col items-center gap-6 text-center">
        ...
        <div className="flex flex-col gap-2 items-center">
          <h2 className="text-2xl md:text-3xl 2xl:text-5xl font-semibold tracking-tight text-neutral-800">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
          ...
          <button
            ...
            disabled={!isReady}
            title={!isReady ? 'Pilih rentang tanggalnya dulu, ya' : undefined}
            className={cn(
        ...
        <p className={cn(
          ...
          {isReady && dateRange?.from && dateRange?.to
            ...
            : 'Yuk, pilih rentang tanggal dulu supaya kita bisa mulai analisisnya'}
        </p>
